...
// Compatibility adapter can feed the existing Settings v3 renderer during migration.
...
// Migration is idempotent once canonical.
...
console.log("PASS: V4 can temporarily adapt back to v3 during strangler migration");
